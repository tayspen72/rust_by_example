...
fn match_pointers_and_references(){
...
fn the_match(){
    ...
    //the match statement can 'destructure' items in specific ways
    match_tuples();
    match_enums();
    match_pointers_and_references();
    match_structs();
...
fn the_while_let(){
    ...
    //used to conditionally loop based on a matched condition
